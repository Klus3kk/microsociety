...
struct GameConfig {
    ...
    static constexpr int NPCEntityCount = 5;    // NPC count on start
    ...
    static constexpr float BASE_UPGRADE_COST = 100.0f; // For house upgrades
    static constexpr float MAX_HEALTH = 100.0f; // Health max stats for NPC
